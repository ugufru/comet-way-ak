 ...
 * matching and replacement. This class uses java.util.regex.
 */
public class jGrep
{		// protected static Perl5Util perl;
	...
	{
		return (indecesOf(pattern, content, ignoreCase, null));
	}
	...
	{
		return (grepText(pattern, content, ignoreCase, null));
	}
	...
	public static String grepAndReplaceText(String pattern, String replacementString, String content, boolean ignoreCase, Pattern compiledPattern)
	{
		try {
			...
			// Invalid regex pattern, return original content
			return content;
		}
	}
	...
	{
		return (grepAndReplaceText(pattern, replacementString, content, ignoreCase, null));
	}
